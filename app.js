  ...
  return (
    <div className="container">
      {props.planets.map( planet =>
        <Planet
          {...planet}         // Spread operator works as shortcut, don't have to define each planet property
          key={planet.id}
        />
      )}
    </div>
...
ReactDOM.render(
  <PlanetList planets={planets} />,     // Pass Planets array as props here
  document.getElementById('root')
)
